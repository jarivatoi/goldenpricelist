    ...
    <div className="bg-white border-b border-gray-200 p-4 shadow-sm sticky top-[64px] z-30">
      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          className="block w-full pl-12 pr-12 py-3 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        />
        <button
